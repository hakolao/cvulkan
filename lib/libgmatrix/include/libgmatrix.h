...
/*   Updated: 2020/08/16 16:55:49 by ohakola          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ml_vector3_dot(t_vec3 v1, t_vec3 v2, t_vec3 res);
void		ml_vector3_cross(t_vec3 v1, t_vec3 v2, t_vec3 res);
void		ml_vector3_to_v4(t_vec3 v1, t_vec4 res);
...
void		ml_matrix4_rotate(float rad_x, float rad_y, float rad_z,
			t_mat4 res);
void		ml_matrixr_print(t_mat4 v);
